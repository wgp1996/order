...
public class CgRkdSingleServiceImpl implements ICgRkdSingleService
{
    ...
    public int checkDjNumber(String djNumber,String id){
        return cgRkdMapper.checkDjNumber(djNumber,id);
    }
    /**
     * 新增进货单
     * 
     ...
     */
    @Override
    public int cancleCgRkdSingleStatus(String[] ids){
        return cgRkdMapper.cancleCgRkdSingleStatus(ids);
    }
    /**
     * 查询是否存在下级采购订单
     *
    ...
    public int checkChildOrder(String djNumber){
        return cgRkdMapper.checkChildOrder(djNumber);
    }
    /**
     * 根据编号修改生效进货单状态
     *
