    ...
    <el-row :gutter="20">
      <el-col :span="24" :xs="24">
        ...
        >
          ...
          <el-table-column label="采购日期" align="center" prop="cgTime" width="110" />
          <el-table-column label="下单日期" align="center" prop="orderTime"  width="110"/>
          <el-table-column label="入库时间" align="center" prop="rkTime"  width="110"/>
          <el-table-column label="交货时间" align="center" prop="jhTime" width="110"/>
          <!-- <el-table-column label="收货人" align="center" prop="shPersonName" /> -->
          <el-table-column
            label="操作"
            align="center"
...
<script>
import { cgddList } from "@/api/system/cgddInfo";
export default {
  name: "Stall",
  data() {
    return {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      cgddList(this.queryParams).then((response) => {
